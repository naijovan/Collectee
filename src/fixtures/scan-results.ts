...
const VALORANT_SCAN = {
  ...
  detections: [
    ...
    { id: 'vdet-04', itemId: 'valorant-voidglass-blade', confidence: 0.95, outcome: 'matched', ocrText: 'Voidglass Blade', candidateItemIds: [], frameIndex: 2 },
    ...
    { id: 'vdet-08', itemId: 'valorant-riftblade-katana', confidence: 0.87, outcome: 'needs_review', ocrText: 'Riftbl… Katana', candidateItemIds: ['valorant-riftblade-katana', 'val-glitchpop-vandal'], frameIndex: 4 },
