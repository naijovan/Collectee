...
const CODM_SCAN = {
  ...
  detections: [
    ...
    { id: 'det-15', itemId: 'codm-charm-golden-skull', confidence: 0.96, outcome: 'matched', ocrText: 'GOLDEN SKULL', candidateItemIds: [], frameIndex: 9 },
    ...
    { id: 'det-21', itemId: 'codm-charm-dog-tag', confidence: 0.66, outcome: 'needs_review', ocrText: null, candidateItemIds: ['codm-charm-dog-tag', 'codm-charm-brass-shell'], frameIndex: 12 },
...
const VALORANT_SCAN = {
  ...
  detections: [
    ...
    { id: 'vdet-04', itemId: 'val-prime-karambit', confidence: 0.95, outcome: 'matched', ocrText: 'Prime Karambit', candidateItemIds: [], frameIndex: 2 },
    ...
    { id: 'vdet-08', itemId: 'val-glitchpop-vandal', confidence: 0.87, outcome: 'needs_review', ocrText: 'Glitchp… Vandal', candidateItemIds: ['val-glitchpop-vandal', 'val-origin-vandal'], frameIndex: 4 },
...
const MLBB_SCAN = {
  ...
  durationMs: 5800,
  detections: [
    { id: 'mdet-01', itemId: 'mlbb-gusion-cyber-faust', confidence: 0.97, outcome: 'matched', ocrText: 'Cyber Faust', candidateItemIds: [], frameIndex: 1 },
    { id: 'mdet-02', itemId: 'mlbb-gusion-cyber-ops', confidence: 0.94, outcome: 'matched', ocrText: 'Cyber Ops', candidateItemIds: [], frameIndex: 1 },
    { id: 'mdet-03', itemId: 'mlbb-hayabusa-shadow-vanguard', confidence: 0.93, outcome: 'matched', ocrText: 'Shadow Vanguard', candidateItemIds: [], frameIndex: 2 },
    { id: 'mdet-04', itemId: 'mlbb-lesley-cyber-blossom', confidence: 0.95, outcome: 'matched', ocrText: 'Cyber Blossom', candidateItemIds: [], frameIndex: 2 },
    { id: 'mdet-05', itemId: 'mlbb-kagura-cherry-witch', confidence: 0.92, outcome: 'matched', ocrText: 'Cherry Witch', candidateItemIds: [], frameIndex: 3 },
    { id: 'mdet-06', itemId: 'mlbb-layla-malefic-gunner', confidence: 0.96, outcome: 'matched', ocrText: 'Malefic Gunner', candidateItemIds: [], frameIndex: 3 },
    { id: 'mdet-07', itemId: 'mlbb-lancelot-royal-matador', confidence: 0.81, outcome: 'needs_review', ocrText: 'Royal Mat…', candidateItemIds: ['mlbb-lancelot-royal-matador', 'mlbb-alucard-obsidian-blade'], frameIndex: 4 },
    { id: 'mdet-08', itemId: 'mlbb-chou-dragon-boy', confidence: 0.68, outcome: 'needs_review', ocrText: 'Dr▚gon Boy', candidateItemIds: ['mlbb-chou-dragon-boy', 'mlbb-zilong-eastern-warrior'], frameIndex: 4 },
    { id: 'mdet-09', itemId: 'mlbb-gusion-cyber-faust', confidence: 0.91, outcome: 'duplicate', ocrText: 'Cyber Faust', candidateItemIds: [], frameIndex: 5 },
