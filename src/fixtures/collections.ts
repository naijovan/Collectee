 ...
 *
 * `scripts/tmp` is gone, but the check it ran is worth repeating after any
 * edit here: every `ownedItemId` below must be a real row in `owned-items.ts`,
 * owned by the collection's owner, verified, and listed in that collection.
 */
export const ROOMS: readonly Room[] = [
   ...
   */
  {
    ...
    themeId: 'theme-weapon-vault',
    title: 'Receipts',
    description: 'Eight skins, one linked account, nothing to argue about.',
    coverUrl: '',
    backdropUrl: 'room-backdrops/weapon-vault.png',
    slots: [
      { id: 'vault-wall-1', kind: 'wall', x: 0.05, y: 0.1, w: 0.19, h: 0.24, depth: 0 },
    ...
    placements: [
      { slotId: 'vault-pedestal-hero', ownedItemId: 'own-zennx-val-elderflame-vandal', rotation: 0 },
      { slotId: 'vault-pedestal-left', ownedItemId: 'own-zennx-val-prime-karambit', rotation: 0 },
      { slotId: 'vault-pedestal-right', ownedItemId: 'own-zennx-val-voidglass-blade', rotation: 0 },
      { slotId: 'vault-case-1', ownedItemId: 'own-zennx-codm-dlq33-lightbringer', rotation: 0 },
      { slotId: 'vault-case-2', ownedItemId: 'own-zennx-codm-drh-cerberus', rotation: 0 },
      { slotId: 'vault-wall-1', ownedItemId: 'own-zennx-mlbb-gusion-cyber-faust', rotation: 0 },
      { slotId: 'vault-wall-2', ownedItemId: 'own-zennx-mlbb-void-empress', rotation: 0 },
      { slotId: 'vault-wall-3', ownedItemId: 'own-zennx-mlbb-neon-ronin', rotation: 0 },
    ],
    settings: {
      parallaxEnabled: true,
      focusedSlotId: null,
  ...
  {
    id: 'room-zennx-dawn-signal',
    collectionId: 'col-zennx-dawn-signal',
    themeId: 'theme-cyber-shrine',
    title: 'Signal Shrine',
    description: 'Three from the Land of Dawn. The fourth is still unverified.',
    coverUrl: '',
    backdropUrl: 'room-backdrops/cyber-shrine.png',
    slots: [
    ...
    placements: [
      { slotId: 'shrine-pedestal-hero', ownedItemId: 'own-zennx-mlbb-gusion-cyber-faust', rotation: 0 },
      { slotId: 'shrine-case-left', ownedItemId: 'own-zennx-mlbb-void-empress', rotation: 0 },
      { slotId: 'shrine-case-right', ownedItemId: 'own-zennx-mlbb-neon-ronin', rotation: 0 },
    ],
    settings: {
      parallaxEnabled: true,
      focusedSlotId: null,
    ...
    createdAt: '2026-07-15T21:05:00.000Z',
  },
  {
    ...
    placements: [
      { slotId: 'vault-pedestal-hero', ownedItemId: 'own-syafiq-codm-drh-cerberus', rotation: 0 },
      { slotId: 'vault-pedestal-left', ownedItemId: 'own-syafiq-codm-qq9-diavolo', rotation: 0 },
      { slotId: 'vault-pedestal-right', ownedItemId: 'own-syafiq-codm-ghost-nightfall', rotation: 0 },
    ],
    settings: {
      parallaxEnabled: true,
      focusedSlotId: null,
  ...
  },
  {
    ...
    description: 'Quiet shelf, loud skins.',
    coverUrl: '',
    ...
    placements: [
      ...
      { slotId: 'study-case-left', ownedItemId: 'own-priya-mlbb-manifold-rift', rotation: 0 },
      { slotId: 'study-case-right', ownedItemId: 'own-priya-mlbb-kagura-cherry-witch', rotation: 0 },
    ],
    settings: {
      parallaxEnabled: true,
      focusedSlotId: null,
  ...
  {
    id: 'room-tarek-marksman',
    collectionId: 'col-tarek-marksman',
    themeId: 'theme-esports-locker',
    title: 'Long Shot',
    description: 'Every one of these has taken a game off someone.',
    coverUrl: '',
    backdropUrl: 'room-backdrops/esports-locker.png',
    slots: [
      { id: 'locker-pedestal-hero', kind: 'pedestal', x: 0.38, y: 0.44, w: 0.24, h: 0.34, depth: 2 },
      { id: 'locker-case-left', kind: 'case', x: 0.08, y: 0.5, w: 0.18, h: 0.26, depth: 1 },
      { id: 'locker-case-right', kind: 'case', x: 0.74, y: 0.5, w: 0.18, h: 0.26, depth: 1 },
      { id: 'locker-wall-1', kind: 'wall', x: 0.12, y: 0.14, w: 0.16, h: 0.22, depth: 0 },
      { id: 'locker-wall-2', kind: 'wall', x: 0.32, y: 0.1, w: 0.16, h: 0.22, depth: 0 },
      { id: 'locker-wall-3', kind: 'wall', x: 0.52, y: 0.1, w: 0.16, h: 0.22, depth: 0 },
      { id: 'locker-wall-4', kind: 'wall', x: 0.72, y: 0.14, w: 0.16, h: 0.22, depth: 0 },
    ],
    placements: [
      { slotId: 'locker-pedestal-hero', ownedItemId: 'own-tarek-codm-dlq33-lightbringer', rotation: 0 },
      { slotId: 'locker-case-left', ownedItemId: 'own-tarek-codm-locus-ironclad', rotation: 0 },
      { slotId: 'locker-case-right', ownedItemId: 'own-tarek-codm-fennec-ascended', rotation: 0 },
    ],
    settings: {
      parallaxEnabled: true,
      focusedSlotId: null,
    ...
    likeCount: 1388,
    visitorCount: 3241,
    publishedAt: '2026-05-24T08:40:00.000Z',
    createdAt: '2026-05-23T19:15:00.000Z',
  },
  {
    id: 'room-nova-proof',
  ...
  {
    id: 'room-bo-reaver',
    collectionId: 'col-bo-reaver-set',
    themeId: 'theme-fantasy-armoury',
    title: 'Reaver Hall',
    description: 'Two years to finish. Worth it.',
    coverUrl: '',
    backdropUrl: 'room-backdrops/fantasy-armoury.png',
    slots: [
      { id: 'armoury-pedestal-hero', kind: 'pedestal', x: 0.38, y: 0.44, w: 0.24, h: 0.34, depth: 2 },
    ...
    placements: [
      { slotId: 'armoury-pedestal-hero', ownedItemId: 'own-bo-val-reaver-vandal', rotation: 0 },
      { slotId: 'armoury-case-left', ownedItemId: 'own-bo-val-reaver-sheriff', rotation: 0 },
      { slotId: 'armoury-case-right', ownedItemId: 'own-bo-val-reaver-knife', rotation: 0 },
    ],
    settings: {
      parallaxEnabled: true,
      focusedSlotId: null,
    ...
    likeCount: 3417,
    visitorCount: 8892,
    publishedAt: '2026-05-04T15:22:00.000Z',
    createdAt: '2026-05-03T12:09:00.000Z',
  },
];
